...
const Footer = () => {
  ...
  return (
    <div className="flex flex-col justify-around mt-30 bg-slate-300 pt-6 pb-6 wrap gap-10 w-auto lg:flex-row lg:justify-evenly xl:justify-evenly">
      <div className="flex flex-row ml-15 md:mx-10 gap-3 justify-around lg:flex-row lg:mx-0 lg:gap-20 xl:gap-50">
        ...
        <div className="flex flex-col gap-3 w-[50%] md:w-auto">
          ...
          <div className="flex flex-row gap-3 text-sm lg:text-lg ">
            ...
            <div>judeachristministry@gmail.com</div>
          </div>

          <a href="https://maps.app.goo.gl/K1UBacWEwEGKzRVP8">
            <div className="flex flex-row gap-3 text-sm w-[40px] lg:text-lg ">
              <div>
                <svg
                  width="20"
                  height="28"
            ...
            <div>
              ...
              >
                <g>
                  ...
                  <path
                    fill="#fff"
                    d="M32 17.5v21c0 .4.4.7.8.6l17-10.5c.3-.2.3-.6 0-.8l-17-10.5c-.3-.2-.8.1-.8.6z"
                  />
                </g>
              </svg>
            </div>
